...
var attachmentMagick = {
  startup: function(){
    ...
    if ( $('#attachmentProgressContainer') ) { attachmentMagick.prepareImageUpload( this.data_attachment ); }
    ...
    this.elementSortable.sortable({ update: function(event, ui){ attachmentMagick.updateImageList( $(this) ); }});
  },
  removeImage: function(el){
    ...
    var url_path      = "/publisher/images/"+image_id+"/"+this.data_attachment
  ...
  prepareImageUpload: function(data_attachment){
  	var swfu = new SWFUpload({
          upload_url : 					        '/publisher/images/',
          post_params : 					      { 'data_attachment' : data_attachment },
  ...
  uploadVideo: function(){
    var $el 			  = $("#image_source");
  	var method 		  = 'post';
  	var form_action = '/publisher/images';
  	...
  	$.ajax({
  	  type: method,
  	  url:  form_action, 
  	  data: {"source" : form_data, data_attachment: this.data_attachment},
